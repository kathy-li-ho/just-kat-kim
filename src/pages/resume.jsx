...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 85.271 114.521">
  ...
  <path fill="lemonchiffon" d="M57.048 39.656h28.223L45.568 0l.033 28.223c.008 6.316 5.13 11.433 11.447 11.433z"/>
  <path fill="khaki" d="M59.321 37.383c6.417.333 25.95 2.273 25.95 2.273L45.568 0s1.767 19.496 2.306 25.95c.526 6.295 5.139 11.107 11.447 11.433z"/>
  <path fill="khaki" d="M85.271 39.656L45.568 0"/>
</svg>`;
