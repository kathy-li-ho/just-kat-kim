...
const resumeRegex = /(<a href=")(.*resume.*\?dl=)0".*(\2)0<\/a>/i;
...
const PortfolioPage = () => {
    ...
    const contentWithResumeCTA = contentHTML.replace(resumeRegex, resumeCTA);
    const contentWithVideo = contentWithResumeCTA.replace(
        videoRegex,
        videoPlayer
    );

    useLayoutEffect(() => insertContent(contentWithVideo));
